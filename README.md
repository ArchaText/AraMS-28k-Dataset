...
Download the image archive from [AraMS-28k Dataset](https://huggingface.co/datasets/mguechaoui/AraMS-28k/tree/main) and extract it so that the folder structure matches the paths used in the annotation files.
